...
type ('s, 'r) _menhir_state = 
  ...
  | MenhirState26 : (('s, _menhir_box_prog) _menhir_cell1_instr, _menhir_box_prog) _menhir_state
    (** State 26.
        Stack shape : instr.
        Start symbol: prog. *)
...
include struct
  ...
  let _menhir_run_25 : type  ttv_stack. ttv_stack -> _ -> _menhir_box_prog =
  ...
  and _menhir_run_27 : type  ttv_stack. (ttv_stack, _menhir_box_prog) _menhir_cell1_instr -> _ -> _menhir_box_prog =
    fun _menhir_stack _v ->
      let MenhirCell1_instr (_menhir_stack, _menhir_s, e) = _menhir_stack in
      let p = _v in
      let _v = _menhir_action_11 e p in
      _menhir_goto_prog _menhir_stack _v _menhir_s
  
  let _menhir_run_24 : type  ttv_stack. ttv_stack -> (ttv_stack, _menhir_box_prog) _menhir_state -> _menhir_box_prog =
    ...
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _startpos _v _menhir_s _tok ->
      ...
      | Lcpar ->
          ...
          | Lfin ->
              ...
              let _v = _menhir_action_10 _startpos_e_ e in
  ...
  and _menhir_goto_instr : type  ttv_stack. ttv_stack -> _ -> _ -> _ -> (ttv_stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      ...
      match (_tok : MenhirBasics.token) with
      | Lvariable _v_0 ->
          _menhir_run_01 _menhir_stack _menhir_lexbuf _menhir_lexer _v_0 MenhirState26
      | Ltypes _v_1 ->
          _menhir_run_13 _menhir_stack _menhir_lexbuf _menhir_lexer _v_1 MenhirState26
      | Lreturn ->
      ...
      | Lend ->
          _menhir_run_24 _menhir_stack MenhirState26
      | _ ->
          _eRR ()
  ...
  let _menhir_run_00 : type  ttv_stack. ttv_stack -> _ -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer ->
      ...
      | Lend ->
          _menhir_run_24 _menhir_stack _menhir_s
      | _ ->
          _eRR ()
